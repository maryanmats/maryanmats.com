...
Since React 18, rendering is *concurrent*. React can pause mid-render to handle higher-priority work (like user input), then resume. This is what makes `startTransition` and Suspense work smoothly.
